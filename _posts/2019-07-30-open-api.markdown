...
![SwaggerHub Login]({{ "/assets/2019-07-30/swagger_hub_login.png" | absolute_url }})

After the login you will see your personal Hub where you can create a new API:

![Hub Create API]({{ "/assets/2019-07-30/hub_create_api.png" | absolute_url }})
...
![Project Management API]({{ "/assets/2019-07-30/project_mgmt_api.png" | absolute_url }})

And the data structures are as following:

![Datastructures]({{ "/assets/2019-07-30/api_datastructures.png" | absolute_url }})
...
![Specification Tags]({{ "/assets/2019-07-30/specification_tags.png" | absolute_url }})
...
![Specification Operation ID]({{ "/assets/2019-07-30/specification_operation_id.png" | absolute_url }})
...
![Download Angular Client Code]({{ "/assets/2019-07-30/download_angular_client.png" | absolute_url }})
...
![Angular Compile Error]({{ "/assets/2019-07-30/angular_compile_error.png" | absolute_url }})
...
![Python Flask Server Stub Download]({{ "/assets/2019-07-30/download_flask_stub.png" | absolute_url }})
